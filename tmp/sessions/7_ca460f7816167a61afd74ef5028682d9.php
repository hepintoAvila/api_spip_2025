<?php
$GLOBALS['visiteur_session']['id_auteur'] = '7';
$GLOBALS['visiteur_session']['nom'] = 'labfisica';
$GLOBALS['visiteur_session']['bio'] = '';
$GLOBALS['visiteur_session']['email'] = 'labfisica@unicesar.edu.co';
$GLOBALS['visiteur_session']['nom_site'] = '';
$GLOBALS['visiteur_session']['url_site'] = '';
$GLOBALS['visiteur_session']['login'] = 'labfisica';
$GLOBALS['visiteur_session']['statut'] = '0minirezo';
$GLOBALS['visiteur_session']['webmestre'] = 'non';
$GLOBALS['visiteur_session']['maj'] = '2025-09-20 07:51:30';
...
$GLOBALS['visiteur_session']['tipo'] = 'Labfisica';
$GLOBALS['visiteur_session']['entidad'] = 'cb_1';
$GLOBALS['visiteur_session']['id_rol'] = '5';
$GLOBALS['visiteur_session']['status'] = 'Activo';
$GLOBALS['visiteur_session']['clave'] = '123456';
$GLOBALS['visiteur_session']['tipo_usuario'] = 'Labfisica';
$GLOBALS['visiteur_session']['id_aspirante'] = '5';
...
$GLOBALS['visiteur_session']['date_session'] = 1758289669;
?>
