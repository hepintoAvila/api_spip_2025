<?php
$GLOBALS['visiteur_session']['id_auteur'] = '6';
$GLOBALS['visiteur_session']['nom'] = 'aguachica';
$GLOBALS['visiteur_session']['bio'] = '';
$GLOBALS['visiteur_session']['email'] = 'aguachica@unicesar.edu.co';
$GLOBALS['visiteur_session']['nom_site'] = '';
$GLOBALS['visiteur_session']['url_site'] = '';
$GLOBALS['visiteur_session']['login'] = 'aguachica';
$GLOBALS['visiteur_session']['statut'] = '0minirezo';
$GLOBALS['visiteur_session']['webmestre'] = 'non';
$GLOBALS['visiteur_session']['maj'] = '2025-09-18 08:46:20';
...
$GLOBALS['visiteur_session']['tipo'] = 'Aguachica';
$GLOBALS['visiteur_session']['entidad'] = 'cb_1';
$GLOBALS['visiteur_session']['id_rol'] = '4';
$GLOBALS['visiteur_session']['status'] = 'Activo';
$GLOBALS['visiteur_session']['clave'] = '123456';
$GLOBALS['visiteur_session']['tipoEntrevista'] = 'Virtualteca';
$GLOBALS['visiteur_session']['auth'] = 'spip';
$GLOBALS['visiteur_session']['hash_env'] = 'c0f44952a31d491735ed61d88a0272fd';
$GLOBALS['visiteur_session']['ip_change'] = true;
$GLOBALS['visiteur_session']['date_session'] = 1758125145;
$GLOBALS['visiteur_session']['tipo_usuario'] = 'Aguachica';
$GLOBALS['visiteur_session']['id_aspirante'] = '4';
