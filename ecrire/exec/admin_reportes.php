...
function exec_admin_reportes_dist($get=array(),$post=array()){
		...
		if (!is_array($resdataCredencials)){
		 ...
		 $adminreportes = charger_fonction('adminreportes', 'admin_reportes');
		$json = $adminreportes($opcion, $data,$resdataCredencials);
