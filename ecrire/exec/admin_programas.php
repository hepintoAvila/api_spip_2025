...
function exec_admin_programas_dist($get=array(),$post=array()){
		...
		if (!is_array($resdataCredencials)){
		 ...
		 $adminprogramas = charger_fonction('adminprogramas', 'admin_programas');
		 
		$json = $adminprogramas($opcion, $data,$resdataCredencials);
