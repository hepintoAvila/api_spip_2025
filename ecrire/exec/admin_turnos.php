...
function exec_admin_turnos_dist($get=array(),$post=array()){
		...
		if (!is_array($resdataCredencials)){
		 ...
		 $adminturnos = charger_fonction('adminturnos', 'admin_turnos');
		$json = $adminturnos($opcion, $data,$resdataCredencials);
