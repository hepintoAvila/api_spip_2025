...
function exec_admin_permisos_dist($get=array(),$post=array()){
		...
		if (!is_array($resdataCredencials)){
		 ...
		 $adminpermisos = charger_fonction('adminpermisos', 'admin_permisos');
		$json = $adminpermisos($opcion, $data,$resdataCredencials);
