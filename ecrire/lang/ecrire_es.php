...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	//INFORMES
	'info_bienvenida' => 'Bienvenido. Por favor, registra tus datos personales para acceder a la evaluaciones.',
	'info_clear' => '',
	'info_no_existen_pruebas' => 'No hay pruebas programadas para la fecha actual.',
	'info_finalizada_pruebas' => 'La evaluaciones ya ha finalizado.',
	'info_finalizada_pruebas_no_permiso' => 'Has completado la evaluaciones. No tienes permiso para acceder de nuevo.',
	'info_finalizada_pruebas_no_tiempo' =>'Has completado la evaluaciones. Tu tiempo excedió lo permitido por la evaluaciones.',
	'info_finalizada_pruebas_no_oportunidades' =>'Has completado la evaluaciones. Tus oportunidades excedieron lo permitido por la evaluaciones.',
	'info_finalizada_pruebas_no_activas' =>'No hay evaluaciones activas para este periodo.',
	'info_validar_email' =>'Por favor, cambie el email,ya que este existe en nustra base de datos',
	'info_email_invalido' =>'El email fue intento de intenta inyectar código SQL malicioso en la dirección de correo',
	'info_no_autorizado' =>'Error: No autorizado',
	'info_bienvenida_registrado' =>'Bienvenido: ya puedes comenzar la prueba',
