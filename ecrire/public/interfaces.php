...
function declarer_interfaces() {
	...
	$GLOBALS['table_des_tables']['permisos'] = 'permisos';
	...
	$GLOBALS['table_des_traitements']['ENTI'][] = _TRAITEMENT_RACCOURCIS;
	...
	$GLOBALS['table_des_traitements']['ENTIDAD'][] = _TRAITEMENT_TYPO;
